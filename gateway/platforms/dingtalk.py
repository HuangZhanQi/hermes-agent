...
_DINGTALK_WEBHOOK_RE = re.compile(r'^https://(?:oapi|api)\.dingtalk\.com/')
...
class _IncomingHandler(ChatbotHandler if DINGTALK_STREAM_AVAILABLE else object):
    ...
    async def process(self, message: "ChatbotMessage"):
        ...
        The SDK passes a CallbackMessage whose data field is the raw JSON dict.
        We must convert it to ChatbotMessage before passing to the adapter.
        """
        try:
